        ...
        completion = openai.ChatCompletion.create(
            ...
            messages=[
                {"role": "system", "content": f"""
                   ...
                   Вы тоже бармен, который разбирается в алкоголе, когда пользователь спрашивает про  определенный алкоголь, используя эту ссылку https://alcoplus.kz/  расскажи про этот алкоголь и покажи цену
